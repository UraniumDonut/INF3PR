...
public class FassadeBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_countValue = 0;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_countValue] = new PropertyDescriptor ( "countValue", eieruhr.Fassade.class, "getCountValue", "setCountValue" ); // NOI18N
        }
    ...
    private static final int EVENT_clockZeroListener = 0;
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_clockZeroListener] = new EventSetDescriptor ( eieruhr.Fassade.class, "clockZeroListener", eieruhr.ClockZeroListener.class, new String[] {"notifyClockZero"}, "addClockZeroListener", "removeClockZeroListener" ); // NOI18N
    ...
    private static final int METHOD_startCounter0 = 0;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_startCounter0] = new MethodDescriptor(eieruhr.Fassade.class.getMethod("startCounter", new Class[] {})); // NOI18N
            methods[METHOD_startCounter0].setDisplayName ( "" );
        }
